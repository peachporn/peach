...
INSERT INTO "new_Movie" ("id", "createdAt", "title", "actors", "cover", "websiteId", "path", "volumeId") SELECT "id", "createdAt", "title", "actors", "cover", "websiteId", "path", "volumeId" FROM "Movie";
DROP TABLE "Movie";
