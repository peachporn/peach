export default {
  ...
  ACTION_POSITION_CHANGE: 'Change position to {{genre}}',
  ACTION_LOCATION_START: 'Set location to {{genre}}',
  ACTION_LOCATION_CHANGE: 'Change location to {{genre}} ',
  ACTION_CLOTHING_START: 'Put on {{genre}}',
  ACTION_CLOTHING_END: 'Take off {{genre}}',
  ACTION_PRACTICE_START: 'Start {{genre}}',
  ACTION_PRACTICE_END: 'Stop {{genre}}',
  ACTION_PRACTICE_CHANGE: 'Change practices to {{genre}}',
  ACTION_PRACTICE_ADD_CHILD: 'Add {{genre}} to {{parent}}',
  ACTION_FILM_START: 'Start filming {{genre}}',
  ACTION_FILM_END: 'End filming {{genre}}',
  ACTION_FILM_SET_FULLLENGTH: 'Film {{genre}} for whole movie',
  ...
  ACTION_BODYPART_ADD_CHILD: 'Add {{genre}} to {{parent}}',
} as const;
