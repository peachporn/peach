export default {
  ...
  FOUND_X_MOVIES: '{{count}} movies found, showing {{from}}-{{to}}',
  FOUND_X_ACTRESSES: '{{count}} actresses found, showing {{from}}-{{to}}',
  FOUND_X_WEBSITES: '{{count}} websites found, showing {{from}}-{{to}}',
  FOUND_X_GENRES: '{{count}} genres found, showing {{from}}-{{to}}',
  ...
  MOVIE_FILTER_INPUT: 'Filter...',
  MOVIE_FILTERCARD_ACTRESS: 'Actress',
  MOVIE_FILTERCARD_WEBSITE: 'Website',
  MOVIE_FILTERCARD_FETISH: 'Fetish',
  MOVIE_FILTERCARD_UNTOUCHED: 'Only Untouched',
  MOVIE_FILTERCARD_TITLE: 'Title',
  MOVIE_TITLE: 'Title',
  ...
  ACTRESS_GENDER_EXPRESSION: 'Gender expression',
  ...
  ACTRESS_CUPSIZE: 'Cup',
  ACTRESS_HAS_IMPLANTS: 'Has implants?',
  ACTRESS_IMPLANTS: 'with implants',
  ACTRESS_EQUIPMENT: 'Equipment',
  EQUIPMENT_DICK: 'Dick',
  EQUIPMENT_PUSSY: 'Pussy',
  EQUIPMENT_TITS: 'Tits',
  ...
  ACTRESS_MEASUREMENTS_CHEST: 'Chest',
